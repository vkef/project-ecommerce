<div class="sl-logo"><a href=""><i class="icon ion-android-star-outline"></i> company</a></div>
<div class="sl-sideleft">
  ...
  <div class="sl-sideleft-menu">  
    ...
    <ul class="sl-menu-sub nav flex-column">
      <li class="nav-item"><a href="{{route('admin.category')}}" class="nav-link">Main Category</a></li>
