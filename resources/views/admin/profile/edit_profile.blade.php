    ...
    <div class="col-md-5">
        ...
        <form method="POST" action="{{route('admin.profile.store')}}" enctype='multipart/form-data'>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="name" class="form-control" value="{{$editData->name}}" placeholder="Admin Name">
            </div>

            <div class="mb-3">
                <label for="exampleInputEmail1">Admin Email</label>
                <input type="email" name="email" class="form-control" value="{{$editData->email}}" placeholder="Admin Email">
            </div>
